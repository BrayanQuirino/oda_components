...
> Generated by `@oracle/bots-node-sdk` on **Fri Apr 05 2019**
...
curl -H "Content-Type: application/json" -d @./spec/test.req.json localhost:3000/components/quoteofday
```
